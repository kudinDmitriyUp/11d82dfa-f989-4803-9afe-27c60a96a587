...
export const metadata: Metadata = {
  title: "Luxury Watch Showroom Dubai | Timepiece Dubai",
  description: "Dubai's premier luxury watch destination featuring Rolex, Patek Philippe, Omega & more. Authorized dealer with 25+ years expertise. Visit our exclusive showroom today.",
  keywords: "luxury watches Dubai, Rolex Dubai, Patek Philippe, Omega watches, luxury timepieces, watch showroom Dubai, Swiss watches, premium watches",
  metadataBase: new URL("https://timepiecedubai.com"),
  alternates: {
    canonical: "https://timepiecedubai.com"
  },
  openGraph: {
    title: "Luxury Watch Showroom Dubai | Timepiece Dubai",
    description: "Dubai's premier luxury watch destination featuring the world's finest timepieces from Rolex, Patek Philippe, Omega and more prestigious brands.",
    siteName: "Timepiece Dubai",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763456991647-cep8bv6z.jpg",
      alt: "Luxury watches collection Dubai"
    }],
    type: "website"
  },
  twitter: {
    ...
    title: "Luxury Watch Showroom Dubai | Timepiece Dubai",
    description: "Discover the world's most prestigious watch collections in the heart of Dubai.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32pj8e1GcgiOEWWC6aYveoEdoWX/uploaded-1763456991647-cep8bv6z.jpg"]
  },
  robots: {
    index: true,
    follow: true
